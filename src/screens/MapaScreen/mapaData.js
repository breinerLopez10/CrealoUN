...
import audioFile from './Audios/Boyaca/daniel.mp3';
import audiocas from './Audios/Casanare/jhohan_naranjo.mp3';
import oriany from './Audios/Casanare/oriany.pdf';
import cesar from './Audios/Cesar/rafael.pdf';
import davidCundinamarca from './Audios/Cundinamarca/david_mauricio.pdf';
import guaviare from './Audios/Guaviare/alejandro.pdf';
import dianaNarino from './Audios/Narino/diana.pdf';
import evelynarino from './Audios/Narino/evelyn.pdf';
import carlaSucre from './Audios/Sucre/carla.pdf';
import escuchaton from './Audios/Norte_santander/escuchaton.mp3';
import danielaSantander from './Audios/Santander/daniela.mp3';
import luisanNortedesantander from './Audios/Norte_santander/cartilla.pdf';

const videoMeta="https://youtu.be/bSqOmbnwV6M"
const videoCundinamarca = "https://youtu.be/lqGzKEnWN3c?si=MD9whOhJ0He0pzao"
const videoHuila = "https://www.youtube.com/watch?v=EMiCm4gbCTc"
const videoSantander = "https://www.youtube.com/watch?v=jaGpKcy-k2k"
...
export const mapa = [
    {
      ...
      },
      {
        ...
        "path": "m 267.15,75.139162 0.88,-0.22 7.55,-4.18 0.32,-1.25 0.36,-1.28 4.2,-4.27 2.19,-2.12 0.29,-0.24 -0.03,0.24 0.81,2.01 1.32,0.84 0.97,0.92 0.53,0.89 2.21,4.07 0.11,5.72 -0.07,2.72 -0.22,4.29 -0.38,1.8 -1.9,1.26 -0.89,0.84 -0.74,0.95 -2.24,5.11 -1.73,4.21 -3.15,-2.67 -4.91,-2.97 -5.06,-3.66 -0.34,-1.77 0.31,-1.35 0.23,-1.05 0.08,-1.21 -0.24,-1.36 -0.78,-2.35 1.04,-0.95 -0.37,-1.37 -0.63,0.66 0.08,-1.44 z"
      },
      {
        "id": "CO-BOL",
        "nombre": "Bolívar",
      ...
      },
      {
        ...
        "path": "m 248.16,327.66916 0.6,-0.28 4.3,0.31 2.69,0.41 1.23,0.33 1.13,-0.04 2.6,-1.49 0.29,0.55 -3.27,4.79 -2.84,3.41 -1.24,1.59 -0.47,0.92 0.09,1.94 -0.1,1.64 -0.31,0.84 -0.35,0.79 -0.39,0.73 -0.51,0.65 -1.03,1.2 -2.49,3.73 -0.42,2.12 0.05,1.1 -0.92,-0.65 -0.75,-1.33 -0.62,-2.08 -0.76,-2.69 -2.88,-12.71 -0.29,-1.41 0.1,-0.95 0.66,-0.59 2.07,0.18 1.98,-0.04 1.86,-0.38 0.48,-0.8 z"
      },
      {
        "id": "CO-RIS",
        "nombre": "Risaralda",
      ...
      },
      {
        ...
        "path": "m 0.54,4.489162 -0.29,-0.26 0,-2.05 0.26,-0.83 0.38,-0.64 0.51,-0.42 0.45,0.19 -0.4,2.25 -0.47,1.04 -0.32,0.69 z"
      },
      {
        "id": "CO-TOL",
        "nombre": "Tolima",
